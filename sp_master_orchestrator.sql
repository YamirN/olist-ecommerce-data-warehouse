...
BEGIN
    SET NOCOUNT ON;
    SET XACT_ABORT ON; -- ⚠️ IMPORTANTE: Si algo falla, se detiene todo y hace rollback automático de la transacción actual
    ...
    BEGIN CATCH
        ...
        -- Opcional: Registrar fallo global en una tabla de logs maestros
        -- INSERT INTO audit.global_log ...
        
        -- Relanzar error para que quien llamó al SP se entere
        THROW; 
    END CATCH
END;
GO
